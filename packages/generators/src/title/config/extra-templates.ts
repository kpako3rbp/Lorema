...
const LA_EXTRA_TEMPLATES: Record<TitleLengthPreset, string[]> = {
  xsm: [
    '{topic} overview',
    '{topic} trends',
    '{topic} today',
...
export const EXTRA_TEMPLATES_BY_LANGUAGE: Record<GenerationLanguage, Record<TitleLengthPreset, string[]>> = {
  ru: RU_EXTRA_TEMPLATES,
  en: EN_EXTRA_TEMPLATES,
  la: LA_EXTRA_TEMPLATES,
};
