...
export const ADDRESS_PARTS_LA: AddressParts = {
  countries: ['Imperium Romanum', 'Res Publica Romana', 'Terra Antiqua'],

  regions: ['Latium', 'Campania', 'Etruria', 'Umbria', 'Sicilia', 'Gallia', 'Hispania', 'Lusitania'],
  ...
  streetTypes: ['Via', 'Vicus', 'Forum', 'Porta', 'Campus', 'Insula', 'Clivus'],
