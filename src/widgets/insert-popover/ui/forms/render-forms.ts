import { ContentType, StorageSchema } from 'src/entities/generation-settings/model';
import { Language } from 'src/shared/model/types';
import { POPOVER_TAB_CLASSNAME } from 'src/widgets/insert-popover/config/constants';
