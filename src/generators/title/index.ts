import { Language, TitleSettings, TitleTopic } from '../../types';
import { getRandomItem } from '../../utils/random';

const TOPICS: Exclude<TitleTopic, 'random'>[] = [
  'business',
  'it',
  'project',
  'task',
...
const TITLES: Record<Language, Record<Exclude<TitleTopic, 'random'>, string[]>> = {
  ru: {
